...
public:
    ...
    void setupUi(QWidget *WorkspaceDialog)
    {
        if (WorkspaceDialog->objectName().isEmpty())
            WorkspaceDialog->setObjectName(QStringLiteral("WorkspaceDialog"));
        ...
        PresetWScombo->setObjectName(QStringLiteral("PresetWScombo"));

        horizontalLayout_3->addWidget(PresetWScombo);

        Preset_Label = new QLabel(WorkspaceDialog);
        Preset_Label->setObjectName(QStringLiteral("Preset_Label"));
        ...
        LatDimSpin->setObjectName(QStringLiteral("LatDimSpin"));
        ...
        LatDim_Label->setObjectName(QStringLiteral("LatDim_Label"));
        ...
        ZV_Spin->setObjectName(QStringLiteral("ZV_Spin"));
        ZV_Spin->setMaximum(999);

        verticalLayout->addWidget(ZV_Spin);

        ZV_Label = new QLabel(WorkspaceDialog);
        ZV_Label->setObjectName(QStringLiteral("ZV_Label"));
        ...
        XDimAdj_Label->setObjectName(QStringLiteral("XDimAdj_Label"));
        ...
        YDimAdj_Spin->setObjectName(QStringLiteral("YDimAdj_Spin"));
        ...
        YDimAdj_Label->setObjectName(QStringLiteral("YDimAdj_Label"));
        ...
        ZDimAdj_Spin->setObjectName(QStringLiteral("ZDimAdj_Spin"));
        ...
        ZDimAdj_Label->setObjectName(QStringLiteral("ZDimAdj_Label"));
        ...
        XLineOff_Spin->setObjectName(QStringLiteral("XLineOff_Spin"));
        ...
        XLineOff_Label->setObjectName(QStringLiteral("XLineOff_Label"));
        ...
        YLineOff_Spin->setObjectName(QStringLiteral("YLineOff_Spin"));
        ...
        YLineOff_Label->setObjectName(QStringLiteral("YLineOff_Label"));
        ...
        XLayerOff_Spin->setObjectName(QStringLiteral("XLayerOff_Spin"));
        ...
        XLayerOff_Label->setObjectName(QStringLiteral("XLayerOff_Label"));
        ...
        YLayerOff_Spin->setObjectName(QStringLiteral("YLayerOff_Spin"));
        ...
        YLayerOff_Label->setObjectName(QStringLiteral("YLayerOff_Label"));
        ...
        XSqueeze_Spin->setObjectName(QStringLiteral("XSqueeze_Spin"));
        ...
        XSqueeze_Label->setObjectName(QStringLiteral("XSqueeze_Label"));
        ...
        YSqueeze_Spin->setObjectName(QStringLiteral("YSqueeze_Spin"));
        ...
        YSqueeze_Label->setObjectName(QStringLiteral("YSqueeze_Label"));
        ...
        ZSqueeze_Spin->setObjectName(QStringLiteral("ZSqueeze_Spin"));
        ...
        ZSqueeze_Label->setObjectName(QStringLiteral("ZSqueeze_Label"));
    ...
    {
        WorkspaceDialog->setWindowTitle(QApplication::translate("WorkspaceDialog", "Workspace", 0));
        Preset_Label->setText(QApplication::translate("WorkspaceDialog", "Scheme", 0));
        LatDim_Label->setText(QApplication::translate("WorkspaceDialog", "Lattice Dim (mm)", 0));
        XV_Label->setText(QApplication::translate("WorkspaceDialog", "X Voxels", 0));
        YV_Label->setText(QApplication::translate("WorkspaceDialog", "Y Voxels", 0));
        ZV_Label->setText(QApplication::translate("WorkspaceDialog", "Z Voxels", 0));
        XCustom_Label->setText(QApplication::translate("WorkspaceDialog", "Custom Settings:", 0));
        XDimAdj_Label->setText(QApplication::translate("WorkspaceDialog", "X Dim Adjust", 0));
        YDimAdj_Label->setText(QApplication::translate("WorkspaceDialog", "Y Dim Adjust", 0));
        ZDimAdj_Label->setText(QApplication::translate("WorkspaceDialog", "Z Dim Adjust", 0));
        XLineOff_Label->setText(QApplication::translate("WorkspaceDialog", "X Line Offset", 0));
        YLineOff_Label->setText(QApplication::translate("WorkspaceDialog", "Y Line Offset", 0));
        XLayerOff_Label->setText(QApplication::translate("WorkspaceDialog", "X Layer Offset", 0));
        YLayerOff_Label->setText(QApplication::translate("WorkspaceDialog", "Y Layer Offset", 0));
        CustomSettings->setTabText(CustomSettings->indexOf(LatticeTab), QApplication::translate("WorkspaceDialog", "Lattice", 0));
        Voxel_Label->setText(QApplication::translate("WorkspaceDialog", "Voxel Shape", 0));
        XSqueeze_Label->setText(QApplication::translate("WorkspaceDialog", "X Squeeze", 0));
        YSqueeze_Label->setText(QApplication::translate("WorkspaceDialog", "YSqueeze", 0));
        ZSqueeze_Label->setText(QApplication::translate("WorkspaceDialog", "Z Squeeze", 0));
        CustomSettings->setTabText(CustomSettings->indexOf(VoxelTab), QApplication::translate("WorkspaceDialog", "Voxel Display", 0));
    } // retranslateUi
